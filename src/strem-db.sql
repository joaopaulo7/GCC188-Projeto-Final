...
CREATE TABLE IF NOT EXISTS `strem`.`jogo_a_pagar` (
  ...
  PRIMARY KEY (`jogo_id_jogo`, `clientes_id`),
  INDEX `fk_jogo_has_clientes_clientes1_idx` (`clientes_id` ASC) VISIBLE,
  INDEX `fk_jogo_has_clientes_jogo1_idx` (`jogo_id_jogo` ASC) VISIBLE,
  CONSTRAINT `fk_jogo_has_clientes_jogo1`
    FOREIGN KEY (`jogo_id_jogo`)
    REFERENCES `strem`.`jogo` (`id_jogo`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `strem`.`jogo_has_desenvolvedora` (
  ...
  PRIMARY KEY (`jogo_id_jogo`, `desenvolvedora_id_desenvolvedora`),
  INDEX `fk_jogo_has_desenvolvedora_desenvolvedora1_idx` (`desenvolvedora_id_desenvolvedora` ASC) VISIBLE,
  INDEX `fk_jogo_has_desenvolvedora_jogo1_idx` (`jogo_id_jogo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `strem`.`jogo_has_categoria` (
  ...
  PRIMARY KEY (`jogo_id_jogo`, `categoria_id_categoria`),
  INDEX `fk_jogo_has_categoria_categoria1_idx` (`categoria_id_categoria` ASC) VISIBLE,
  INDEX `fk_jogo_has_categoria_jogo1_idx` (`jogo_id_jogo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `strem`.`biblioteca` (
  ...
  `jogo_id_jogo` INT(10) UNSIGNED NOT NULL,
  `data_compra` DATETIME NOT NULL,
  PRIMARY KEY (`clientes_id`, `jogo_id_jogo`),
  INDEX `fk_clientes_has_jogo_jogo1_idx` (`jogo_id_jogo` ASC) VISIBLE,
