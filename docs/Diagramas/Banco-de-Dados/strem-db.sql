...
-- Table `strem`.`midias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `strem`.`midias` (
  `id_midias` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(100) NOT NULL,
  `formato` VARCHAR(10) NOT NULL,
  `url` VARCHAR(256) NOT NULL,
  PRIMARY KEY (`id_midias`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `strem`.`categoria_has_midias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `strem`.`categoria_has_midias` (
  `categoria_id_categoria` INT(10) UNSIGNED NOT NULL,
  `midias_id_midias` INT NOT NULL,
  PRIMARY KEY (`categoria_id_categoria`, `midias_id_midias`),
  INDEX `fk_categoria_has_midias_midias1_idx` (`midias_id_midias` ASC) VISIBLE,
  INDEX `fk_categoria_has_midias_categoria1_idx` (`categoria_id_categoria` ASC) VISIBLE,
  CONSTRAINT `fk_categoria_has_midias_categoria1`
    FOREIGN KEY (`categoria_id_categoria`)
    REFERENCES `strem`.`categoria` (`id_categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_categoria_has_midias_midias1`
    FOREIGN KEY (`midias_id_midias`)
    REFERENCES `strem`.`midias` (`id_midias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `strem`.`desenvolvedora_has_midias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `strem`.`desenvolvedora_has_midias` (
  `desenvolvedora_id_desenvolvedora` INT(10) NOT NULL,
  `midias_id_midias` INT NOT NULL,
  PRIMARY KEY (`desenvolvedora_id_desenvolvedora`, `midias_id_midias`),
  INDEX `fk_desenvolvedora_has_midias_midias1_idx` (`midias_id_midias` ASC) VISIBLE,
  INDEX `fk_desenvolvedora_has_midias_desenvolvedora1_idx` (`desenvolvedora_id_desenvolvedora` ASC) VISIBLE,
  CONSTRAINT `fk_desenvolvedora_has_midias_desenvolvedora1`
    FOREIGN KEY (`desenvolvedora_id_desenvolvedora`)
    REFERENCES `strem`.`desenvolvedora` (`id_desenvolvedora`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_desenvolvedora_has_midias_midias1`
    FOREIGN KEY (`midias_id_midias`)
    REFERENCES `strem`.`midias` (`id_midias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `strem`.`console_has_midias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `strem`.`console_has_midias` (
  `console_id_console` INT(10) NOT NULL,
  `midias_id_midias` INT NOT NULL,
  PRIMARY KEY (`console_id_console`, `midias_id_midias`),
  INDEX `fk_distribuidora_has_midias_midias1_idx` (`midias_id_midias` ASC) VISIBLE,
  INDEX `fk_distribuidora_has_midias_distribuidora1_idx` (`console_id_console` ASC) VISIBLE,
  CONSTRAINT `fk_distribuidora_has_midias_distribuidora1`
    FOREIGN KEY (`console_id_console`)
    REFERENCES `strem`.`console` (`id_console`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_distribuidora_has_midias_midias1`
    FOREIGN KEY (`midias_id_midias`)
    REFERENCES `strem`.`midias` (`id_midias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `strem`.`jogo_has_midias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `strem`.`jogo_has_midias` (
  `jogo_id_jogo` INT(10) UNSIGNED NOT NULL,
  `jogo_Console_id_console` INT(10) NOT NULL,
  `midias_id_midias` INT NOT NULL,
  PRIMARY KEY (`jogo_id_jogo`, `jogo_Console_id_console`, `midias_id_midias`),
  INDEX `fk_jogo_has_midias_midias1_idx` (`midias_id_midias` ASC) VISIBLE,
  INDEX `fk_jogo_has_midias_jogo1_idx` (`jogo_id_jogo` ASC, `jogo_Console_id_console` ASC) VISIBLE,
  CONSTRAINT `fk_jogo_has_midias_jogo1`
    FOREIGN KEY (`jogo_id_jogo` , `jogo_Console_id_console`)
    REFERENCES `strem`.`jogo` (`id_jogo` , `Console_id_console`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_jogo_has_midias_midias1`
    FOREIGN KEY (`midias_id_midias`)
    REFERENCES `strem`.`midias` (`id_midias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
